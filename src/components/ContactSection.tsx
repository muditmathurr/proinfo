          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center text-[#ffb100] dark:text-[#ffb100] mr-4">
                  <Mail size={24} />
                </div>
                <div>
                  <h4 className="text-sm text-gray-500 dark:text-gray-400 mb-1">Email</h4>
                  <a href="mailto:contact@proinfo.io" className="text-lg font-medium hover:text-[#ffb100] dark:hover:text-[#ffb100] transition-colors">
                  Info@proinfo.io
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  Plot No. D-107, Sector 2, <br /> Noida, Uttar Pradesh – 201301 India.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-purple-100 dark:hover:bg-purple-900/30 hover:text-[#ffb100] dark:hover:text-[#ffb100] transition-colors">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className="w-full bg-[#ffb100] from-purple-600 to-teal-500 hover:bg-[#2a2930] hover:to-teal-600 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 transform hover:shadow-lg flex items-center justify-center"
                >
                  {isSubmitting ? (
